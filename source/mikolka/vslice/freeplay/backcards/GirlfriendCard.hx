...
class GirlfriendCard extends BackingCard
{
	...
	public override function init():Void
	{
		...
		moreWays.funnyColor = 0xFFFF93DF;
		moreWays.speed = 6.8;
		add(moreWays);

		funnyScroll.funnyColor = 0xFFEB39AB;
		funnyScroll.speed = -3.8;
		add(funnyScroll);

		txtNuts.funnyColor = 0xFFFF9FFF;
		txtNuts.speed = 3.5;
		add(txtNuts);

		funnyScroll2.funnyColor = 0xFFEB39AB;
		funnyScroll2.speed = -3.8;
		add(funnyScroll2);

		moreWays2.funnyColor = 0xFFFF93DF;
		moreWays2.speed = 6.8;
		add(moreWays2);

		funnyScroll3.funnyColor = 0xFFEA4529;
	...
	public override function introDone():Void
	{
		...
		pinkBack.color = 0xFFFF78BF;
		orangeBackShit.color = 0xFFFF5F72;
		alsoOrangeLOL.color = 0xFFFF5F72;
